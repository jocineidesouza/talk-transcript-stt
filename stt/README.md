...
- `SUMMARY_MODEL_MINUTE` (padrao `openai/gpt-5.6-luna`)
- `SUMMARY_MODEL_ACCUMULATED` (padrao `openai/gpt-5.6-luna`)
- `SUMMARY_MODEL_FINAL` (padrao `openai/gpt-5.6-luna`)
- `SUMMARY_MODEL_FINAL_TEXT` (padrao `openai/gpt-5.6-luna`)
